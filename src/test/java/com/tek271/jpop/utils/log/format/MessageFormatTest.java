package com.tek271.jpop.utils.log.format;
...
import static com.tek271.jpop.utils.log.LogLevel.*;
import static com.tek271.jpop.utils.log.format.MessageFormat.DATE_FORMAT_DEFAULT;
import static com.tek271.jpop.utils.log.format.MessageFormat.DEFAULT_FORMAT;
...
class MessageFormatTest {
  ...
  void classNameDepth_test() {
    ...
    assertEquals("jpop.utils.log.format.MessageFormatTest", msg);

    msg = sut.clear().className(5).buildMessage(DEBUG, frame, "foo", null);
    assertEquals("tek271.jpop.utils.log.format.MessageFormatTest", msg);

    msg = sut.clear().className(6).buildMessage(DEBUG, frame, "foo", null);
    assertEquals("com.tek271.jpop.utils.log.format.MessageFormatTest", msg);
  ...
  void throwable_test() {
    ...
    assertTrue(lines.get(2).startsWith("com.tek271.jpop.utils.log.format.MessageFormatTest.throwable_test"));
  }
